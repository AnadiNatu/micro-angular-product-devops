...
check_endpoint "Auth Service"   "http://localhost:8082/api/auth/health" "200"
check_endpoint "Demo Service 1" "http://localhost:8080/api/en1/test/public" "200"
check_endpoint "Demo Service 2" "http://localhost:8084/api/en2/test/public" "200"
